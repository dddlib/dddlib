namespace dddlib.Playground.Domain
{
    ...
    public class RegistrationD
    {
        ...
        public RegistrationD(string areaCode, int ageIdentifier, string randomLetters)
        {
        ...
        {
            get { return RegistrationAreas[AreaCode[0]]; }
        }

        public int YearRegistered
        {
            get { return 2000 + (this.AgeIdentifier > 50 ? this.AgeIdentifier - 50 : this.AgeIdentifier); }
        }
    }
}
